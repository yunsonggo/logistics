    ...
    <el-card style="margin-top: 20px; width: 1024px">
      ...
      >
        ...
        <el-form-item label="提供服务">
          <el-checkbox-group v-model="suppGive" @change="getSuppGive">
            <el-checkbox
        ...
        <el-form-item label="商家评分">
          ...
          >服务评分
          <el-input-number
            v-model="suppInfo.delivery_score"
            :precision="2"
            :step="0.1"
            :max="10"
            style="width: 150px"
        ...
        <el-form-item label="banner" prop="banner">
          <el-upload
            ...
            action="http://192.168.1.102:8081/backend/auth/manager/addsupplier/banner/upload"
        ...
        <el-form-item label="Logo" prop="icon">
          <el-upload
            class="avatar-uploader"
            action="http://192.168.1.102:8081/backend/auth/manager/addsupplier/logo/upload"
            name="supp_logo_file"
        ...
        <el-form-item>
          <el-button type="primary" @click="handleAddSuppForm"
            >立即提交</el-button
          >
...
import { reqSuppAdd } from "../../../api/index";
export default {
  name: "suppadd",
  data() {
    return {
  ...
  methods: {
    ...
    getSuppState() {
      ...
      console.log(this.suppInfo.state);
    },
    getSuppUnion() {
      this.suppUnion
    ...
    handleAddSuppForm() {
      ...
      this.handleAddSupp(supp);
    },
    // 取消
    editSuppFormReset() {
      this.$router.go(-1);
    },
    async handleAddSupp(supp) {
      console.log(supp);
      const result = await reqSuppAdd(this.manager_token, supp);
      console.log(result);
      if (result.code === 0) {
        this.$message({
          message: "添加商家成功",
