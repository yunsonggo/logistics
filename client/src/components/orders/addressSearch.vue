        ...
        <div class="search-view">
            <div class="search-box">
                <div class="search-box-input">
                    ...
                    <input type="text" placeholder="街道/小区/写字楼/学校" v-model="search_address">
                </div>
                <button @click="$emit('closeSearch')" class="search-box-btn">取消</button>
            </div> 
            <ul class="search-list">
                <li @click="selectedAddr(item)" class="search-row" v-for="(item,index) in areaList" :key="index">
...
export default {
    ...
    methods: {
        ...
        selectedAddr(item) {
            ...
            this.addressInfo.lng = item.location.lng
            this.addressInfo.lat = item.location.lat
            this.addressInfo.addrName = item.name
