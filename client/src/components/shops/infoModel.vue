        ...
        <div class="info-model" v-if="showInfoModel">
            <div class="brief-modal">
                ...
                <ul>
                    ...
                    <li>
                        <h3>{{rst.delivery_price}}元</h3>
                        <p>基本运费</p>
                    </li>
                    <li>
                        <h3 v-if="theDistanceMe">({{theDistanceMe.toFixed(2)}}KM)</h3>
                        <p>距离</p>
                    </li>
                </ul>
                <h3 class="promotion">
                ...
                <p class="brief-modal-yx">{{rst.description}}</p>
            </div>
            <!-- 叉号 -->
            <div class="brief-modal-close" @click="$emit('closeInfoModel')">
                <img :src="static_url + '/asset/images/closexx.png'" alt="">
            </div>
        </div>
    </transition>
</template>
